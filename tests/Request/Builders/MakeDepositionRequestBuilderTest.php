...
class MakeDepositionRequestBuilderTest extends TestCase
{
    public function testBuild()
    {
        $instance = new MakeDepositionRequestBuilder();
        ...
        $this->assertEquals('makeDepositionRequest', $makeDepositionRequest->getRequestName());
    }
}